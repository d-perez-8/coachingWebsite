  ...
  function (
    ...
    class Carousel extends BaseComponent__default.default {
      ...
      _addTouchEventListeners() {
        for (const img of SelectorEngine__default.default.find(
          SELECTOR_ITEM_IMG,
          this._element,
        )) {
          EventHandler__default.default.on(img, EVENT_DRAG_START, (event) =>
        ...
        this._swipeHelper = new Swipe__default.default(
          this._element,
          swipeConfig,
        );
      }
      ...
      _getActive() {
        return SelectorEngine__default.default.findOne(
    ...
    EventHandler__default.default.on(
      ...
      function (event) {
        ...
        if (
          Manipulator__default.default.getDataAttribute(this, "slide") ===
          "next"
        ) {
          carousel.next();
