(function webpackUniversalModuleDefinition(root, factory) {
  ...
  else root["Cleave"] = factory(root["React"]);
      ...
      /***/ function (module, exports, __webpack_require__) {
        ...
        var cleaveReactClass = CreateReactClass({
          ...
          initTimeFormatter: function initTimeFormatter() {
            ...
            pps.timeFormatter = new TimeFormatter(
              pps.timePattern,
              pps.timeFormat,
            );
          ...
          onInput: function onInput(value, fromProps) {
            ...
            value =
              pps.maxLength > 0 ? Util.headStr(value, pps.maxLength) : value;
          ...
          updateCreditCardPropsByValue: function updateCreditCardPropsByValue(
            value,
          ) {
            var owner = this,
              pps = owner.properties,
          ...
          render: function render() {
            ...
            var _owner$props2 = owner.props,
              ...
              propsToTransfer = _objectWithoutProperties(_owner$props2, [
                "value",
                "options",
                "onKeyDown",
                "onFocus",
	...
	*/
      ...
      /***/ function (module, exports) {
        ...
        DateFormatter.prototype = {
          ...
          addLeadingZeroForYear: function addLeadingZeroForYear(
            number,
            fullYearMode,
          ) {
            if (fullYearMode) {
      ...
      /***/ function (module, exports) {
        ...
        var Util = {
          ...
          getDelimiterREByDelimiter: function getDelimiterREByDelimiter(
            delimiter,
          ) {
            return new RegExp(
          ...
          fixPrefixCursor: function fixPrefixCursor(
            el,
            prefix,
            delimiter,
            delimiters,
