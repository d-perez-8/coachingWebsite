...
!(function (e, t) {
      ...
      t.prototype[e] = function (...t) {
        ...
        if (
          ("initImg" === e &&
            ...
            (n.pureOptions.speed =
              n.$item.getAttribute("data-jarallax-element") || "100")),
        ...
        switch (
          ...
          case "init": {
            ...
            const a = n.pureOptions.threshold.split(" ");
            (n.options.thresholdY = a[0] ? parseFloat(a[0]) : null),
              (n.options.thresholdX = a[1] ? parseFloat(a[1]) : null),
              o.apply(n, t);
            const s = n.$item.getAttribute("data-jarallax-original-styles");
            return s && n.$item.setAttribute("style", s), !0;
          }
          case "onResize": {
            const e = n.css(n.$item, "transform");
            n.css(n.$item, { transform: "" });
            const t = n.$item.getBoundingClientRect();
            (n.itemData = {
              width: t.width,
              height: t.height,
              y: t.top + n.getWindowData().y,
              x: t.left,
            }),
              n.css(n.$item, { transform: e });
            break;
          }
          case "onScroll": {
            const e = n.getWindowData(),
              t =
                (e.y + e.height / 2 - n.itemData.y - n.itemData.height / 2) /
                (e.height / 2),
              o = t * n.options.speedY,
              a = t * n.options.speedX;
            let s = o,
              i = a;
            null !== n.options.thresholdY &&
              o > n.options.thresholdY &&
              (s = 0),
              null !== n.options.thresholdX &&
                a > n.options.thresholdX &&
                (i = 0),
              n.css(n.$item, { transform: `translate3d(${i}px,${s}px,0)` });
            break;
          }
          case "initImg":
          case "isVisible":
  ...
  return (
    ...
    (t = () => {
      void 0 !== o.jarallax &&
        o.jarallax(document.querySelectorAll("[data-jarallax-element]"));
    }),
