...
(function (global, factory) {
  ...
  class VideoWorker {
    ...
    on(name, callback) {
      ...
      (this.userEventsList[name] || (this.userEventsList[name] = [])).push(
        callback,
      );
    }
    ...
    play(start) {
      ...
      if (self.type === "youtube" && self.player.playVideo) {
        ...
        if (
          global$1$1.YT.PlayerState.PLAYING !== self.player.getPlayerState()
        ) {
    ...
    getImageURL(callback) {
      ...
      if (self.type === "vimeo") {
        ...
        request.open(
          "GET",
          `https://vimeo.com/api/oembed.json?url=${self.url}`,
          true,
        );
    ...
    getVideo(callback) {
      ...
      self.onAPIready(() => {
        ...
        if (self.type === "youtube") {
          ...
          self.playerOptions.events = {
            ...
            onStateChange(e) {
              ...
              if (
                self.options.loop &&
                e.data === global$1$1.YT.PlayerState.ENDED
              ) {
                self.play(self.options.startTime);
              }
          ...
          self.player =
            self.player ||
            new global$1$1.YT.Player(self.playerID, self.playerOptions);
        ...
        if (self.type === "vimeo") {
          ...
          self.player =
            self.player ||
            new global$1$1.Vimeo.Player(self.$video, self.playerOptions); // set current time for autoplay
    ...
    onAPIready(callback) {
      ...
      if (self.type === "youtube") {
        ...
        if (
          (typeof global$1$1.YT === "undefined" ||
            global$1$1.YT.loaded === 0) &&
          ...
          typeof global$1$1.YT === "object" &&
          global$1$1.YT.loaded === 1
        ) {
          callback();
        } else {
