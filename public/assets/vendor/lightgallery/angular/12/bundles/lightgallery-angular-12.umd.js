(function (global, factory) {
  typeof exports === "object" && typeof module !== "undefined"
    ? factory(exports, require("@angular/core"), require("lightgallery"))
    : typeof define === "function" && define.amd
    ? define(
        "lightgallery/angular/12",
        ["exports", "@angular/core", "lightgallery"],
        factory,
      )
    : ((global =
        typeof globalThis !== "undefined" ? globalThis : global || self),
      factory(
        ((global.lightgallery = global.lightgallery || {}),
        (global.lightgallery.angular = global.lightgallery.angular || {}),
        (global.lightgallery.angular["12"] = {})),
        global.ng.core,
        global.lightGallery,
      ));
  ...
  LightgalleryService.ɵfac = i0__namespace.ɵɵngDeclareFactory({
    minVersion: "12.0.0",
    version: "12.2.16",
    ngImport: i0__namespace,
    type: LightgalleryService,
    deps: [],
    target: i0__namespace.ɵɵFactoryTarget.Injectable,
  });
  LightgalleryService.ɵprov = i0__namespace.ɵɵngDeclareInjectable({
    minVersion: "12.0.0",
    version: "12.2.16",
    ngImport: i0__namespace,
    type: LightgalleryService,
  ...
  var LightgalleryComponent = /** @class */ (function () {
    ...
    LightgalleryComponent.prototype.ngAfterViewChecked = function () {
      if (!this.lgInitialized) {
        this.registerEvents();
        this.LG = lightGallery__default["default"](
    ...
    LightgalleryComponent.prototype.registerEvents = function () {
      ...
      if (this.onAfterAppendSlide) {
        this._elementRef.nativeElement.addEventListener(
          ...
          function (event) {
            _this.onAfterAppendSlide && _this.onAfterAppendSlide(event.detail);
          },
        );
      }
      if (this.onInit) {
      ...
      if (this.onContainerResize) {
        this._elementRef.nativeElement.addEventListener(
          ...
          function (event) {
            _this.onContainerResize && _this.onContainerResize(event.detail);
          },
        );
      }
      ...
      if (this.onBeforeNextSlide) {
        this._elementRef.nativeElement.addEventListener(
          ...
          function (event) {
            _this.onBeforeNextSlide && _this.onBeforeNextSlide(event.detail);
          },
        );
      }
      if (this.onBeforePrevSlide) {
        this._elementRef.nativeElement.addEventListener(
          ...
          function (event) {
            _this.onBeforePrevSlide && _this.onBeforePrevSlide(event.detail);
          },
        );
      }
      ...
      if (this.onFlipHorizontal) {
        this._elementRef.nativeElement.addEventListener(
          ...
          function (event) {
            _this.onFlipHorizontal && _this.onFlipHorizontal(event.detail);
          },
        );
      }
  ...
  LightgalleryComponent.ɵfac = i0__namespace.ɵɵngDeclareFactory({
    minVersion: "12.0.0",
    version: "12.2.16",
    ngImport: i0__namespace,
    type: LightgalleryComponent,
    deps: [{ token: i0__namespace.ElementRef }],
    target: i0__namespace.ɵɵFactoryTarget.Component,
  });
  LightgalleryComponent.ɵcmp = i0__namespace.ɵɵngDeclareComponent({
    minVersion: "12.0.0",
    version: "12.2.16",
    type: LightgalleryComponent,
  ...
  LightgalleryModule.ɵfac = i0__namespace.ɵɵngDeclareFactory({
    minVersion: "12.0.0",
    version: "12.2.16",
    ngImport: i0__namespace,
  ...
  LightgalleryModule.ɵmod = i0__namespace.ɵɵngDeclareNgModule({
    minVersion: "12.0.0",
    version: "12.2.16",
    ngImport: i0__namespace,
    type: LightgalleryModule,
  ...
  LightgalleryModule.ɵinj = i0__namespace.ɵɵngDeclareInjector({
    minVersion: "12.0.0",
    version: "12.2.16",
    ngImport: i0__namespace,
    type: LightgalleryModule,
