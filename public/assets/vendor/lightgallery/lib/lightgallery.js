...
var LightGallery = /** @class */ (function () {
  ...
  LightGallery.prototype.generateSettings = function (options) {
    ...
    this.settings = __assign(
      __assign({}, lg_settings_1.lightGalleryCoreSettings),
      options,
    );
    if (
  ...
  LightGallery.prototype.refreshOnResize = function () {
    if (this.lgOpened) {
      ...
      var _a = this.mediaContainerPosition,
        top_1 = _a.top,
        bottom = _a.bottom;
      this.currentImageSize = lg_utils_1.default.getSize(
  ...
  LightGallery.prototype.getItems = function () {
    ...
    if (!this.settings.dynamic) {
      ...
      return lg_utils_1.default.getDynamicOptions(
        this.items,
  ...
  LightGallery.prototype.hideScrollbar = function () {
    ...
    this.bodyPaddingRight = parseFloat(
      lgQuery_1.$LG("body").style().paddingRight,
    );
    var bodyRect = document.documentElement.getBoundingClientRect();
    var scrollbarWidth = window.innerWidth - bodyRect.width;
    lgQuery_1
      .$LG(document.body)
      .css("padding-right", scrollbarWidth + this.bodyPaddingRight + "px");
  ...
  LightGallery.prototype.resetScrollBar = function () {
    ...
    lgQuery_1
      .$LG(document.body)
      .css("padding-right", this.bodyPaddingRight + "px");
  ...
  LightGallery.prototype.openGallery = function (index, element) {
    ...
    if (this.zoomFromOrigin && element) {
      ...
      transform = lg_utils_1.default.getTransform(
        element,
        this.outer,
        top,
        bottom,
  ...
  LightGallery.prototype.setImgMarkup = function (src, $currentSlide, index) {
    ...
    if (this.isFirstSlideWithZoomAnimation()) {
      ...
      imgContent = lg_utils_1.default.getImgMarkup(
        index,
        src,
        altAttr,
        srcset,
  ...
  LightGallery.prototype.onSlideObjectLoad = function (
    ...
    if (
      lg_utils_1.default.isImageLoaded(mediaObject.get()) ||
      isHTML5VideoWithoutPoster
    ) {
      onLoad();
    } else {
  ...
  LightGallery.prototype.addSlideVideoInfo = function (items) {
    ...
    items.forEach(function (element, index) {
      element.__slideVideoInfo = lg_utils_1.default.isVideo(
        element.src,
        !!element.video,
        index,
      );
    ...
    if (!$currentSlide.hasClass("lg-loaded")) {
      if (videoInfo) {
        var _a = this.mediaContainerPosition,
          top_2 = _a.top,
          bottom = _a.bottom;
        var videoSize = lg_utils_1.default.getSize(
          this.items[index],
          this.outer,
          top_2 + bottom,
      ...
      if (iframe) {
        var markup = lg_utils_1.default.getIframeMarkup(
        ...
        var markup = lg_utils_1.default.getVideoPosterMarkup(
          poster,
          dummyImg || "",
          lgVideoStyle,
      ...
      this.LGel.trigger(lg_events_1.lGEvents.afterAppendSlide, {
        index: index,
      });
        ...
        setTimeout(function () {
          if (_this.getSlideType(currentGalleryItem) === "image") {
            ...
            $currentSlide
              .find(".lg-img-wrap")
              .append(
                lg_utils_1.default.getImgMarkup(
                  index,
                  src,
                  altAttr,
                  srcset,
  ...
  LightGallery.prototype.enableSwipe = function () {
    ...
    if (this.settings.enableSwipe) {
      this.$inner.on("touchstart.lg", function (e) {
        ...
        if (
          (lgQuery_1.$LG(e.target).hasClass("lg-item") ||
  ...
  LightGallery.prototype.enableDrag = function () {
    ...
    if (this.settings.enableDrag) {
      ...
      lgQuery_1
        .$LG(window)
        .on("mouseup.lg.global" + this.lgId, function (event) {
          if (!_this.lgOpened) {
            return;
          }
          var target = lgQuery_1.$LG(event.target);
  ...
  LightGallery.prototype.trapFocus = function () {
    ...
    lgQuery_1.$LG(window).on("keydown.lg.global" + this.lgId, function (e) {
      ...
      var focusableEls = lg_utils_1.default.getFocusableElements(
        _this.$container.get(),
      );
  ...
  LightGallery.prototype.closeGallery = function (force) {
    ...
    if (this.zoomFromOrigin && currentItem) {
      ...
      var _b = this.galleryItems[this.index],
        ...
        poster = _b.poster;
      var imageSize = lg_utils_1.default.getSize(
        currentItem,
        this.outer,
        top_4 + bottom,
