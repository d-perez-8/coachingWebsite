...
var Autoplay = /** @class */ (function () {
  function Autoplay(instance) {
    ...
    this.settings = __assign(
      __assign({}, lg_autoplay_settings_1.autoplaySettings),
      this.core.settings,
    );
    return this;
  }
  Autoplay.prototype.init = function () {
    ...
    if (this.settings.slideShowAutoplay) {
      this.core.LGel.once(
        lg_events_1.lGEvents.slideItemLoad + ".autoplay",
        function () {
          _this.startAutoPlay();
        },
      );
    ...
    this.core.LGel.on(
      lg_events_1.lGEvents.dragStart + ".autoplay touchstart.lg.autoplay",
      function () {
        if (_this.interval) {
          _this.stopAutoPlay();
    ...
    this.core.LGel.on(
      lg_events_1.lGEvents.dragEnd + ".autoplay touchend.lg.autoplay",
      function () {
    ...
    this.core.LGel.on(
      lg_events_1.lGEvents.beforeSlide + ".autoplay",
      function () {
    ...
    // restore autoplay if autoplay canceled from touchstart / dragstart
    this.core.LGel.on(
      lg_events_1.lGEvents.afterSlide + ".autoplay",
      function () {
        if (
      ...
      if (this.interval) {
        ...
        setTimeout(function () {
          _$progress_1.css(
            "transition",
            "width " +
              (_this.core.settings.speed + _this.settings.slideShowInterval) +
              "ms ease 0s",
          );
