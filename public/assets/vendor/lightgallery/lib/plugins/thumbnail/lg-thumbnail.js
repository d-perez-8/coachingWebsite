...
var Thumbnail = /** @class */ (function () {
  ...
  Thumbnail.prototype.init = function () {
    ...
    this.settings = __assign(
      __assign({}, lg_thumbnail_settings_1.thumbnailsSettings),
      this.core.settings,
    );
    this.thumbOuterWidth = 0;
  ...
  Thumbnail.prototype.build = function () {
    ...
    this.core.LGel.on(
      lg_events_1.lGEvents.beforeSlide + ".thumb",
      function (event) {
    ...
    this.core.LGel.on(
      lg_events_1.lGEvents.updateSlides + ".thumb",
      function () {
        _this.rebuildThumbnails();
      },
    );
    this.core.LGel.on(
      lg_events_1.lGEvents.containerResize + ".thumb",
      function () {
