...
var Video = /** @class */ (function () {
  function Video(instance) {
    ...
    this.settings = __assign(
      __assign({}, lg_video_settings_1.videoSettings),
      this.core.settings,
    );
    return this;
  }
  Video.prototype.init = function () {
     ...
     */
    this.core.LGel.on(
      lg_events_1.lGEvents.hasVideo + ".video",
    ...
    this.core.LGel.on(
      lg_events_1.lGEvents.slideItemLoad + ".video",
      this.onSlideItemLoad.bind(this),
    );
    // @desc fired immediately before each slide transition.
    this.core.LGel.on(
      lg_events_1.lGEvents.beforeSlide + ".video",
      this.onBeforeSlide.bind(this),
    );
    // @desc fired immediately after each slide transition.
    this.core.LGel.on(
      lg_events_1.lGEvents.afterSlide + ".video",
  ...
  Video.prototype.getVideoHtml = function (src, addClass, index, html5Video) {
    ...
    if (videoInfo.youtube) {
      ...
      var youTubePlayerParams =
        "?" + slideUrlParams + "wmode=opaque&autoplay=0&mute=1&enablejsapi=1";
      var playerParams =
        youTubePlayerParams +
      ...
      var playerParams = lg_video_utils_1.getVimeoURLParams(
      ...
      var playerParams = lg_video_utils_1.param(
      ...
      for (var i = 0; i < html5Video.source.length; i++) {
        html5VideoMarkup +=
          '<source src="' +
          html5Video.source[i].src +
          '" type="' +
          html5Video.source[i].type +
          '">';
      }
  ...
  Video.prototype.appendVideos = function (el, videoParams) {
    var _a;
    var videoHtml = this.getVideoHtml(
      videoParams.src,
