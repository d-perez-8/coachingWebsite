...
var Zoom = /** @class */ (function () {
  function Zoom(instance, $LG) {
    ...
    this.settings = __assign(
      __assign({}, lg_zoom_settings_1.zoomSettings),
      this.core.settings,
    );
    return this;
  }
  ...
  Zoom.prototype.enableZoomOnSlideItemLoad = function () {
    // Add zoomable class
    this.core.LGel.on(
      lg_events_1.lGEvents.slideItemLoad + ".zoom",
  ...
  Zoom.prototype.init = function () {
    ...
    this.core.LGel.on(
      lg_events_1.lGEvents.containerResize +
        ".zoom " +
        lg_events_1.lGEvents.rotateRight +
        ".zoom " +
        lg_events_1.lGEvents.rotateLeft +
        ".zoom " +
        lg_events_1.lGEvents.flipHorizontal +
        ".zoom " +
        lg_events_1.lGEvents.flipVertical +
        ".zoom",
      function () {
        if (
          !_this.core.lgOpened ||
    ...
    this.core.LGel.on(
      lg_events_1.lGEvents.afterSlide + ".zoom",
      function (event) {
