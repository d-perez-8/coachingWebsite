...
!(function (t, e) {
  "object" == typeof exports && "undefined" != typeof module
    ...
    ? define(e)
    : ((t = "undefined" != typeof globalThis ? globalThis : t || self).lgHash =
        e());
})(this, function () {
  "use strict";
  var t = function () {
  ...
  return (function () {
    function s(e, i) {
      return (
        (this.core = e),
        (this.$LG = i),
        (this.settings = t(t({}, o), this.core.settings)),
        this
      );
    }
    return (
        ...
        (e = (this.settings.customSlideName && e) || t.detail.index),
          history.replaceState
            ...
            : (window.location.hash =
                "lg=" + this.settings.galleryId + "&slide=" + e);
      }),
      ...
      (s.prototype.onHashchange = function () {
        if (this.core.lgOpened) {
          ...
          t.indexOf("lg=" + this.settings.galleryId) > -1
            ? this.core.slide(e, !1, !1)
