...
*/
    ...
    /***/ fb15: /***/ function (
      ...
      function _possibleConstructorReturn(self, call) {
        if (
          call &&
          (typeof_default()(call) === "object" || typeof call === "function")
        ) {
          return call;
        }
...
***************************************************************************** */
      ...
      function vue_class_component_esm_bundler_getPrototypeOf(o) {
        vue_class_component_esm_bundler_getPrototypeOf = Object.setPrototypeOf
          ? Object.getPrototypeOf
          : function _getPrototypeOf(o) {
              return o.__proto__ || Object.getPrototypeOf(o);
            };
      ...
      function vue_class_component_esm_bundler_createSuper(Derived) {
        ...
        return function _createSuperInternal() {
          ...
          if (hasNativeReflectConstruct) {
            var NewTarget =
              vue_class_component_esm_bundler_getPrototypeOf(this).constructor;
        ...
        vue_class_component_esm_bundler_createClass(VueImpl, null, [
          ...
          },
          {
            ...
            get: function get() {
              ...
              options.methods = vue_class_component_esm_bundler_objectSpread2(
                {},
                options.methods,
              );
              options.computed = vue_class_component_esm_bundler_objectSpread2(
                {},
                options.computed,
              );
              ...
              options.setup = function (props, ctx) {
                ...
                return (_promise = promise) !== null && _promise !== void 0
                  ? _promise
                  : plainData;
              };
        ...
        return group1.toUpperCase();
            ...
            },
            {
              ...
              value: function offset() {
                ...
                return {
                  left:
                    rect.left - parseFloat(bodyMarginLeft) + this.scrollLeft(),
          ...
          },
          {
            ...
            value: function buildStructure() {
              ...
              var closeIcon =
                this.settings.closable && this.settings.showCloseIcon
                  ? '<button type="button" aria-label="'
                      .concat(this.settings.strings["closeGallery"], '" id="')
                      .concat(
              ...
              var maximizeIcon = this.settings.showMaximizeIcon
                ? '<button type="button" aria-label="'
                    .concat(this.settings.strings["toggleMaximize"], '" id="')
                    .concat(
          ...
          },
          {
            ...
            value: function openGallery() {
              ...
              itemsToBeInsertedToDom.forEach(function (item) {
                items =
                  items + '<div id="'.concat(item, '" class="lg-item"></div>');
              });
            ...
            value: function loadContent(index, rec) {
              ...
              if (!$currentSlide.hasClass("lg-loaded")) {
                ...
                if (iframe) {
                  ...
                  var _markup2 = '<div class="lg-video-cont " style="'.concat(
                    lgVideoStyle,
                    '"></div>',
                  );
                ...
                if (!$currentSlide.hasClass("lg-loaded")) {
                  setTimeout(function () {
                    ...
                    if (
                      ...
                      (_this10.getSlideType(currentGalleryItem) === "video" &&
                        poster)
                    ) {
            ...
            value: function getItemsToBeInsertedToDom(index, prevIndex) {
              ...
              if (index < (this.galleryItems.length - 1) / 2) {
                ...
                for (
                  ...
                  itemsToBeInsertedToDom.push(
                    "lg-item-".concat(this.lgId, "-").concat(index + _idx + 1),
                  );
                }
              } else {
                for (
                ...
                for (
                  ...
                  itemsToBeInsertedToDom.push(
                    "lg-item-".concat(this.lgId, "-").concat(index - _idx3 - 1),
                  );
                }
              }
          ...
          },
          {
            ...
            value: function invalidateItems() {
              for (var index = 0; index < this.items.length; index++) {
                ...
                $element.off(
                  "click.lgcustom-item-".concat($element.attr("data-lg-id")),
                );
              }
            },
          },
