(function webpackUniversalModuleDefinition(root, factory) {
  ...
  else root["LightGalleryVue"] = factory(root["Vue"]);
})(
...
***************************************************************************** */
          ...
          function vue_class_component_esm_bundler_classCallCheck(
            instance,
            Constructor,
          ) {
            if (!(instance instanceof Constructor)) {
          ...
          function vue_class_component_esm_bundler_defineProperties(
            target,
            props,
          ) {
            for (var i = 0; i < props.length; i++) {
          ...
          function vue_class_component_esm_bundler_createClass(
            Constructor,
            protoProps,
            staticProps,
          ) {
            if (protoProps)
              vue_class_component_esm_bundler_defineProperties(
          ...
          function vue_class_component_esm_bundler_defineProperty(
            obj,
            key,
            value,
          ) {
          ...
          function vue_class_component_esm_bundler_ownKeys(
            object,
            enumerableOnly,
          ) {
            var keys = Object.keys(object);
          ...
          function vue_class_component_esm_bundler_objectSpread2(target) {
            for (var i = 1; i < arguments.length; i++) {
              ...
              if (i % 2) {
                vue_class_component_esm_bundler_ownKeys(
                  Object(source),
                  true,
                ).forEach(function (key) {
                  vue_class_component_esm_bundler_defineProperty(
                    target,
                    key,
                    source[key],
                  );
                ...
                vue_class_component_esm_bundler_ownKeys(Object(source)).forEach(
                  function (key) {
                    Object.defineProperty(
                      target,
                      key,
          ...
          function vue_class_component_esm_bundler_inherits(
            subClass,
            superClass,
          ) {
            if (typeof superClass !== "function" && superClass !== null) {
            ...
            if (superClass)
              vue_class_component_esm_bundler_setPrototypeOf(
                subClass,
                superClass,
              );
          }
          ...
          function vue_class_component_esm_bundler_getPrototypeOf(o) {
            vue_class_component_esm_bundler_getPrototypeOf =
              Object.setPrototypeOf
                ? Object.getPrototypeOf
                : function _getPrototypeOf(o) {
                    return o.__proto__ || Object.getPrototypeOf(o);
          ...
          function vue_class_component_esm_bundler_possibleConstructorReturn(
            self,
            call,
          ) {
            if (
          ...
          function vue_class_component_esm_bundler_createSuper(Derived) {
            var hasNativeReflectConstruct =
              vue_class_component_esm_bundler_isNativeReflectConstruct();

            return function _createSuperInternal() {
              var Super =
                  vue_class_component_esm_bundler_getPrototypeOf(Derived),
                result;
              ...
              return vue_class_component_esm_bundler_possibleConstructorReturn(
                this,
                result,
              );
            };
          ...
          var vue_class_component_esm_bundler_VueImpl =
            /*#__PURE__*/ (function () {
              ...
              vue_class_component_esm_bundler_createClass(VueImpl, null, [
                ...
                },
                {
                  ...
                  value: function _with(Props) {
                    ...
                    var PropsMixin = /*#__PURE__*/ (function (_this2) {
                      vue_class_component_esm_bundler_inherits(
                        PropsMixin,
                        _this2,
                      );

                      var _super =
                        vue_class_component_esm_bundler_createSuper(PropsMixin);

                      function PropsMixin() {
                        vue_class_component_esm_bundler_classCallCheck(
                          this,
                          PropsMixin,
                        );
                ...
                },
                {
                  ...
                  get: function get() {
                    ...
                    var options = vue_class_component_esm_bundler_objectSpread2(
                      {},
                      getOwn(Ctor, "__o"),
                    );
                    ...
                    options.methods =
                      vue_class_component_esm_bundler_objectSpread2(
                        {},
                        options.methods,
                      );
                    options.computed =
          ...
          function mixins() {
            ...
            return (
              (_a = /*#__PURE__*/ (function (_Vue) {
                ...
                var _super =
                  vue_class_component_esm_bundler_createSuper(MixedVue);
          ...
          function toConsumableArray_toConsumableArray(arr) {
            return (
              arrayWithoutHoles_arrayWithoutHoles(arr) ||
              iterableToArray_iterableToArray(arr) ||
              unsupportedIterableToArray_unsupportedIterableToArray(arr) ||
              nonIterableSpread_nonIterableSpread()
            );
          }
        ...
        return group1.toUpperCase();
                ...
                },
                {
                  ...
                  value: function on(events, listener) {
                    ...
                    events.split(" ").forEach(function (event) {
                      ...
                      _this2.selector.addEventListener(
                        event.split(".")[0],
                        listener,
                      );
                    });
          ...
          var utils = {
            ...
            getIframeMarkup: function getIframeMarkup(
              iframeWidth,
              iframeHeight,
              iframeMaxWidth,
              iframeMaxHeight,
              ...
              return '<div class="lg-video-cont lg-has-iframe" style="width:'
                .concat(iframeWidth, "; max-width:")
                .concat(iframeMaxWidth, "; height: ")
                .concat(iframeHeight, "; max-height:")
                .concat(
                  iframeMaxHeight,
            ...
            getImgMarkup: function getImgMarkup(
              index,
              src,
              altAttr,
              srcset,
              ...
              var imgMarkup = "<img "
                .concat(altAttr, " ")
                .concat(srcsetAttr, "  ")
                .concat(sizesAttr, ' class="lg-object lg-image" data-index="')
                .concat(index, '" src="')
                .concat(src, '" />');
              var sourceTag = "";
            ...
            getVideoPosterMarkup: function getVideoPosterMarkup(
              _poster,
              dummyImg,
              videoContStyle,
              playVideoString,
            ...
            getDynamicOptions: function getDynamicOptions(
              ...
              var dynamicElements = [];
              var availableDynamicOptions = [].concat(
                defaultDynamicOptions,
                toConsumableArray_toConsumableArray(extraProps),
              );
            ...
            _createClass(LightGallery, [
              {
                ...
                value: function generateSettings(options) {
                  ...
                  this.settings = _objectSpread2(
                    _objectSpread2({}, lightGalleryCoreSettings),
                    options,
                  );
                  ...
                  if (
                    ...
                    var mobileSettings = _objectSpread2(
                      _objectSpread2({}, this.settings.mobileSettings),
                      this.settings.mobileSettings,
                    );

                    this.settings = _objectSpread2(
                      _objectSpread2({}, this.settings),
                      mobileSettings,
                    );
                  }
                },
              ...
              },
              {
                ...
                value: function buildStructure() {
                  ...
                  if (this.settings.controls) {
                    controls = '<button type="button" id="'
                      .concat(this.getIdName("lg-prev"), '" aria-label="')
                      .concat(
                      ...
                      .concat(this.getIdName("lg-next"), '" aria-label="')
                      .concat(
                        this.settings.strings["nextSlide"],
                        '" class="lg-next lg-icon"> ',
                      )
                      .concat(this.settings.nextHtml, " </button>");
                  }
                  ...
                  var ariaDescribedby = this.settings.ariaDescribedby
                    ...
                    : "";
                  var containerClassName = "lg-container "
                    .concat(this.settings.addClass, " ")
                    .concat(
                  ...
                  $LG(window).on(
                    "resize.lg.global"
                      .concat(this.lgId, " orientationchange.lg.global")
                      .concat(this.lgId),
                    function () {
              ...
              },
              {
                ...
                value: function refreshOnResize() {
                  if (this.lgOpened) {
                    ...
                    this.currentImageSize = lg_utils.getSize(
              ...
              },
              {
                ...
                value: function getItems() {
                  ...
                  if (!this.settings.dynamic) {
                    ...
                    return lg_utils.getDynamicOptions(
                      this.items,
              ...
              },
              {
                ...
                value: function openGallery() {
                  ...
                  itemsToBeInsertedToDom.forEach(function (item) {
                    items =
                      items +
                      '<div id="'.concat(item, '" class="lg-item"></div>');
                  });
                  ...
                  if (this.zoomFromOrigin && element) {
                    ...
                    transform = lg_utils.getTransform(
                      element,
                      this.outer,
                      top,
                      bottom,
                  ...
                  setTimeout(function () {
                    ...
                    if (_this5.zoomFromOrigin && transform) {
                      ...
                      setTimeout(function () {
                        currentSlide
                          ...
                          .css(
                            "transition-duration",
                            _this5.settings.startAnimationDuration + "ms",
                          );
                    ...
                    setTimeout(function () {
                      if (
                        _this5.settings.trapFocus &&
                        document.body === _this5.settings.container
                      ) {
                        _this5.trapFocus();
                      }
                  ...
                  if (this.settings.counter) {
                    var counterHtml =
                      '<div class="lg-counter" role="status" aria-live="polite">\n                <span id="'
                        ...
                        .concat(this.galleryItems.length, " </span></div>");
                    this.outer
                ...
                value: function addHtml(index) {
                  ...
                  if (this.settings.appendSubHtmlTo !== ".lg-item") {
                    ...
                    if (subHtmlUrl) {
                      ...
                      currentSlide.append(
                        '<div class="lg-sub-html">'.concat(subHtml, "</div>"),
                      );
                    }
              ...
              },
              {
                ...
                value: function getVideoContStyle(imageSize) {
                  if (!imageSize) return "";
                  return "width:"
                    .concat(imageSize.width, "px;\n                height:")
                    .concat(imageSize.height, "px");
                },
              },
              {
                key: "getDummyImageContent",
                value: function getDummyImageContent(
                  $currentSlide,
                  index,
                  alt,
                ) {
                  ...
                  if ($currentItem) {
                    ...
                    var dummyImgContent = "<img "
                      .concat(alt, ' style="')
                      .concat(imgStyle, '" class="lg-dummy-img" src="')
                      .concat(_dummyImgSrc, '" />');
              ...
              },
              {
                ...
                value: function setImgMarkup(src, $currentSlide, index) {
                  ...
                  if (this.isFirstSlideWithZoomAnimation()) {
                    ...
                    imgContent = lg_utils.getImgMarkup(
                      index,
                      src,
                      altAttr,
                      srcset,
                  ...
                  var imgMarkup = '<picture class="lg-img-wrap"> '.concat(
                    imgContent,
                    "</picture>",
                  );
              ...
              },
              {
                ...
                value: function onSlideObjectLoad(
                  $slide,
                  ...
                  if (
                    lg_utils.isImageLoaded(mediaObject.get()) ||
                    isHTML5VideoWithoutPoster
                  ) {
                    onLoad();
                  } else {
              ...
              },
              {
                ...
                value: function triggerSlideItemLoad(
                  $currentSlide,
                  index,
                  delay,
                  speed,
              ...
              },
              {
                ...
                value: function addSlideVideoInfo(items) {
                  ...
                  items.forEach(function (element, index) {
                    element.__slideVideoInfo = lg_utils.isVideo(
                      element.src,
                      !!element.video,
                      index,
                    );
                    ...
                    if (
                      ...
                      _this9.settings.loadYouTubePoster &&
                      !element.poster &&
                      element.__slideVideoInfo.youtube
                    ) {
                      element.poster = "//img.youtube.com/vi/".concat(
                ...
                value: function loadContent(index, rec) {
                  ...
                  if (!$currentSlide.hasClass("lg-loaded")) {
                    if (videoInfo) {
                      ...
                      var videoSize = lg_utils.getSize(
                        this.items[index],
                        this.outer,
                        top + bottom,
                    ...
                    if (iframe) {
                      var markup = lg_utils.getIframeMarkup(
                      ...
                      var _markup = lg_utils.getVideoPosterMarkup(
                        poster,
                        dummyImg || "",
                        lgVideoStyle,
                      ...
                      var _markup2 =
                        '<div class="lg-video-cont " style="'.concat(
                          lgVideoStyle,
                          '"></div>',
                        );
                  ...
                  if (this.isFirstSlideWithZoomAnimation()) {
                    ...
                    if (!$currentSlide.hasClass("lg-loaded")) {
                      setTimeout(function () {
                        if (
                          _this10.getSlideType(currentGalleryItem) === "image"
                        ) {
                          var alt = currentGalleryItem.alt;
                          var altAttr = alt ? 'alt="' + alt + '"' : "";
                          $currentSlide
                        ...
                        if (
                          _this10.getSlideType(currentGalleryItem) ===
                            "image" ||
                          (_this10.getSlideType(currentGalleryItem) ===
                            "video" &&
                            poster)
                        ) {
                          _this10.onLgObjectLoad(
                            $currentSlide,
                            index,
                            delay,
                            _speed,
                          ...
                          _this10.onSlideObjectLoad(
                            $currentSlide,
                            !!(videoInfo && videoInfo.html5 && !poster),
                            function () {
                              _this10.loadContentOnFirstSlideLoad(
                                index,
                                $currentSlide,
                                _speed,
                              );
              ...
              },
              {
                ...
                value: function loadContentOnFirstSlideLoad(
                  index,
                  $currentSlide,
                  speed,
                ) {
                ...
                value: function getItemsToBeInsertedToDom(index, prevIndex) {
                  ...
                  if (this.galleryItems.length <= 3) {
                    this.galleryItems.forEach(function (_element, index) {
                      itemsToBeInsertedToDom.push(
                        "lg-item-".concat(_this12.lgId, "-").concat(index),
                      );
                    });
                  ...
                  if (index < (this.galleryItems.length - 1) / 2) {
                    for (
                      ...
                      itemsToBeInsertedToDom.push(
                        "lg-item-".concat(this.lgId, "-").concat(idx),
                      );
                    }
                    ...
                    for (
                      var _idx = 0;
                      _idx < possibleNumberOfItems - numberOfExistingItems;
                      _idx++
                    ) {
                      itemsToBeInsertedToDom.push(
                        "lg-item-"
                    ...
                    for (
                      var _idx2 = index;
                      _idx2 <= this.galleryItems.length - 1 &&
                      _idx2 < index + possibleNumberOfItems / 2;
                      _idx2++
                    ) {
                      itemsToBeInsertedToDom.push(
                        "lg-item-".concat(this.lgId, "-").concat(_idx2),
                      );
                    }
                    ...
                    for (
                      var _idx3 = 0;
                      _idx3 < possibleNumberOfItems - _numberOfExistingItems;
                      _idx3++
                    ) {
                      itemsToBeInsertedToDom.push(
                        "lg-item-"
                          .concat(this.lgId, "-")
                          .concat(index - _idx3 - 1),
                      );
                    }
                  }
                  ...
                  if (this.settings.loop) {
                    if (index === this.galleryItems.length - 1) {
                      itemsToBeInsertedToDom.push(
                        "lg-item-".concat(this.lgId, "-", 0),
                      );
                    } else if (index === 0) {
                      itemsToBeInsertedToDom.push(
                        "lg-item-"
                          .concat(this.lgId, "-")
                          .concat(this.galleryItems.length - 1),
                      );
                    }
                  }
                  ...
                  if (itemsToBeInsertedToDom.indexOf(prevIndexItem) === -1) {
                    itemsToBeInsertedToDom.push(
                      "lg-item-".concat(this.lgId, "-").concat(prevIndex),
                    );
                  }
              ...
              },
              {
                ...
                value: function makeSlideAnimation(
                  direction,
                  currentSlideItem,
                  previousSlideItem,
                ) {
                ...
                value: function touchEnd(endCoords, startCoords, event) {
                  ...
                  setTimeout(function () {
                    ...
                    if (_this16.swipeDirection === "horizontal") {
                      ...
                      if (
                        distance < 0 &&
                        distanceAbs > _this16.settings.swipeThreshold
                      ) {
                      ...
                      if (
                        _this16.settings.closable &&
                        _this16.settings.swipeToClose &&
                        distance > 100
                      ) {
                  ...
                  setTimeout(function () {
                    if (
                      !_this16.outer.hasClass("lg-dragging") &&
                      _this16.settings.mode !== "lg-slide"
                    ) {
                  ...
                  if (this.settings.enableSwipe) {
                    this.$inner.on("touchstart.lg", function (e) {
                      ...
                      if (
                        ...
                        !_this17.outer.hasClass("lg-zoomed") &&
                        !_this17.lgBusy &&
                        e.touches.length === 1
                      ) {
                        isSwiping = true;
                  ...
                  if (this.settings.enableDrag) {
                    this.outer.on("mousedown.lg", function (e) {
                      ...
                      if (
                        ...
                        if (
                          !_this18.outer.hasClass("lg-zoomed") &&
                          !_this18.lgBusy
                        ) {
                          e.preventDefault();
                    ...
                    $LG(window).on(
                      "mousemove.lg.global".concat(this.lgId),
                      function (e) {
                    ...
                    $LG(window).on(
                      "mouseup.lg.global".concat(this.lgId),
                      function (event) {
                        if (!_this18.lgOpened) {
                          return;
                        }
              ...
              },
              {
                ...
                value: function triggerPosterClick() {
                  ...
                  this.$inner.on("click.lg", function (event) {
                    if (
                      !_this19.dragOrSwipeEnabled &&
                      _this19.isPosterElement($LG(event.target))
                    ) {
              ...
              },
              {
                ...
                value: function keyPress() {
                  ...
                  $LG(window).on(
                    "keydown.lg.global".concat(this.lgId),
                    function (e) {
                      if (
                        _this22.lgOpened &&
                        _this22.settings.escKey === true &&
                        e.keyCode === 27
                      ) {
                        e.preventDefault();

                        if (
                          _this22.settings.allowMediaOverlap &&
                          _this22.outer.hasClass("lg-can-toggle") &&
                          _this22.outer.hasClass("lg-components-open")
                        ) {
              ...
              },
              {
                ...
                value: function invalidateItems() {
                  for (var index = 0; index < this.items.length; index++) {
                    ...
                    $element.off(
                      "click.lgcustom-item-".concat(
                        $element.attr("data-lg-id"),
                      ),
                    );
                  }
                },
                ...
                value: function trapFocus() {
                  ...
                  $LG(window).on(
                    ...
                    function (e) {
                      ...
                      var focusableEls = lg_utils.getFocusableElements(
                        _this26.$container.get(),
                      );
              ...
              },
              {
                ...
                value: function closeGallery(force) {
                  ...
                  if (this.zoomFromOrigin && currentItem) {
                    ...
                    var imageSize = lg_utils.getSize(
                      currentItem,
                      this.outer,
                      top + bottom,
                  ...
                  setTimeout(function () {
                    ...
                    _this28.$backdrop
                      ...
                      .css(
                        "transition-duration",
                        _this28.settings.backdropDuration + "ms",
                      );

                    _this28.outer.removeClass(
                      "lg-closing ".concat(_this28.settings.startClass),
                    );

                    _this28
                      .getSlideItem(_this28.index)
          ...
          var LightGalleryvue_type_script_lang_ts_Lightgallery =
            /*#__PURE__*/ (function (_Vue) {
                      ...
                      _this.$refs.container.addEventListener(
                        ...
                        function (event) {
                          if (_this[_this.getMethodName(key)]) {
                            _this[_this.getMethodName.call(_this, key)](
                              event.detail,
                            );
                          }
                        },
          ...
          LightGalleryvue_type_script_lang_ts_Lightgallery = __decorate(
            [
              Options({
                props: {
                  settings: {
          ...
          /* harmony default export */ var LightGalleryvue_type_script_lang_ts =
            LightGalleryvue_type_script_lang_ts_Lightgallery;
          ...
          /* harmony default export */ var components_LightGallery =
            LightGalleryvue_type_script_lang_ts;
          // CONCATENATED MODULE: ./node_modules/@vue/cli-service/lib/commands/build/entry-lib.js

          /* harmony default export */ var entry_lib = (__webpack_exports__[
            "default"
          ] = components_LightGallery);
